...
> A parkour obby platformer set across floating sky-islands. Climb, vault, jump, glide. Beat the course before sunset, or fall to the clouds and try again.
...
| Signal | Source |
|---|---|
| PEAK passed 15M players — climbing/parkour platformers are viral | Tight climbing mechanics + emergent comedy |
| Roblox obby culture continues to dominate young-player attention | Direct lane on PC |
| Asset Store ships 'Obby Parkour Mega Pack' — environment + obstacles ready | ~90% coverage |
